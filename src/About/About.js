    ...
    <div className="about py-3">
      <div className="container">
        ...
        <p className="lead fw-bold my-3 ">
          We are providing online store service with super amazing and
          experience team. There are lots of reknown companies are using our
          online store service.Most of the team members and engineers are
          experienced persons.Our experts are always working to provide quality
          service.
        </p>
